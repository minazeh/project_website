            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                ...
                <form id="msform">
                    ...
                    <ul id="progressbar">
                        ...
                        <li id="personal"><strong>Customise Your Greeting</strong></li>
                        <li id="payment"><strong>Receiver & Sender Details</strong></li>
                        <li id="confirm"><strong>Share Your Fortune</strong></li>
                    </ul>

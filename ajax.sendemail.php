...
try {
    ...
    $mail->Username   = 'conrad@toolboxdesign.net';                 // SMTP username
    ...
    <img style="display: block;" class="image_fix" src="'. $_POST['img_url'] .'" width="500" height="500" alt="">
    </td></tr></table></td></tr></table> <br></center></body></html>';
